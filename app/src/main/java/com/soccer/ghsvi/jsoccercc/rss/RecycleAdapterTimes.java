...
public class RecycleAdapterTimes extends  RecyclerView.Adapter<RecycleAdapterTimes.ViewHolder>{
    ...
    public RecycleAdapterTimes.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(com.soccer.ghsvi.jsoccercc.R.layout.rss_feed_item, viewGroup, false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view){
            super(view);
            cardView = (CardView) view.findViewById(com.soccer.ghsvi.jsoccercc.R.id.card_view);
            rssTitle = (TextView) view.findViewById(com.soccer.ghsvi.jsoccercc.R.id.item_title);
            rssDescription = (TextView) view.findViewById(com.soccer.ghsvi.jsoccercc.R.id.item_description);
            rssPubDate = (TextView) view.findViewById(com.soccer.ghsvi.jsoccercc.R.id.item_pub_date);
        }
