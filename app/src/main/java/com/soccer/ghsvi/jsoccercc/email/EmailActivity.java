package com.soccer.ghsvi.jsoccercc.email;
...
public class EmailActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextEmail.setText("developer.jsoccer@gmail.com");
        editTextEmail.setFocusable(false);
        editTextEmail.setClickable(true);
        editTextSubject = (EditText) findViewById(R.id.editTextSubject);

        editTextSubject.setHint("Type your email if you want to receive some feedback.");
        ...
        buttonSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(getApplicationContext(), "Subject and Message can't be empty!!", Toast.LENGTH_LONG).show();
                }
                else
                {
                    sendEmail();
