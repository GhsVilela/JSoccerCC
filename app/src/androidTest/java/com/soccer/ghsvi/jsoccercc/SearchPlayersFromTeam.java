...
public class SearchPlayersFromTeam extends ActivityInstrumentationTestCase2<MainActivity> {

    private Solo solo;

    public SearchPlayersFromTeam() {
    ...
    @SmallTest
    public void testSearchPlayersFromTeam() throws InterruptedException {
        String resultado = "25 Results found for Arsenal";
        ...
        EditText editTextTime = (EditText) solo.getView(R.id.editTextAllPlayers);
